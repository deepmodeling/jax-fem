...
class Problem:
    ...
    dirichlet_bc_info: Optional[
        List[Union[List[Callable], List[int], List[Callable]]]
    ] = None
    ...
    def __post_init__(self):
        ...
        self.fes = [
            FiniteElement(
                ...
                dirichlet_bc_info=(
                    self.dirichlet_bc_info[i]
                    if type(self.dirichlet_bc_info) == type([])
                    else self.dirichlet_bc_info
                ),
            )
